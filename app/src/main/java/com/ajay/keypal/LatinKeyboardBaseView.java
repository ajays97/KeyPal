...
import com.ajay.keypal.Keyboard.Key;
...
//            }
    ...
    private void showKey(final int keyIndex, PointerTracker tracker) {
        ...
        mPreviewText.setBackgroundDrawable(getResources().getDrawable(hasPopup ? R.mipmap.keyboard_key_feedback_more_background : R.mipmap.keyboard_key_feedback_background));
