...
public class LatinKeyboard extends Keyboard {
    ...
    public LatinKeyboard(Context context, int xmlLayoutResId, int mode, float kbHeightPercent) {
        ...
        mMode = mode;
        mRes = res;
        mShiftLockIcon = res.getDrawable(R.mipmap.sym_keyboard_shift_locked);
        mShiftLockPreviewIcon = res.getDrawable(R.mipmap.sym_keyboard_feedback_shift_locked);
        setDefaultBounds(mShiftLockPreviewIcon);
        mSpaceIcon = res.getDrawable(R.mipmap.sym_keyboard_space);
        mSpaceAutoCompletionIndicator = res.getDrawable(R.mipmap.sym_keyboard_space_led);
        mSpacePreviewIcon = res.getDrawable(R.mipmap.sym_keyboard_feedback_space);
        mMicIcon = res.getDrawable(R.mipmap.sym_keyboard_mic);
        mMicPreviewIcon = res.getDrawable(R.mipmap.sym_keyboard_feedback_mic);
        mSettingsIcon = res.getDrawable(R.mipmap.sym_keyboard_settings);
        mSettingsPreviewIcon = res.getDrawable(R.mipmap.sym_keyboard_feedback_settings);
        setDefaultBounds(mMicPreviewIcon);
        mButtonArrowLeftIcon = res.getDrawable(R.mipmap.sym_keyboard_language_arrows_left);
        mButtonArrowRightIcon = res.getDrawable(R.mipmap.sym_keyboard_language_arrows_right);
        m123MicIcon = res.getDrawable(R.mipmap.sym_keyboard_123_mic);
        m123MicPreviewIcon = res.getDrawable(R.mipmap.sym_keyboard_feedback_123_mic);
        mHintIcon = res.getDrawable(R.mipmap.hint_popup);
        setDefaultBounds(m123MicPreviewIcon);
        sSpacebarVerticalCorrection = res.getDimensionPixelOffset(
                R.dimen.spacebar_vertical_correction);
        mIsAlphaKeyboard = xmlLayoutResId == R.xml.qwerty;
            ...
            switch (options&(EditorInfo.IME_MASK_ACTION|EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
                ...
                case EditorInfo.IME_ACTION_SEARCH:
                    mEnterKey.iconPreview = res.getDrawable(
                            R.mipmap.sym_keyboard_feedback_search);
                ...
                default:
                    ...
                    mEnterKey.iconPreview = res.getDrawable(
                            R.mipmap.sym_keyboard_feedback_return);
    ...
    private void updateSpaceBarForLocale(boolean isAutoCompletion) {
        ...
        if (mLocale != null) {
            ...
            if (isAutoCompletion) {
                ...
                mSpaceKey.icon = mRes.getDrawable(R.mipmap.sym_keyboard_space);
            }
        }
    }
    ...
    class SlidingLocaleDrawable extends Drawable {
        ...
        public SlidingLocaleDrawable(Drawable background, int width, int height) {
            ...
            mLeftDrawable =
                    mRes.getDrawable(R.mipmap.sym_keyboard_feedback_language_arrows_left);
            mRightDrawable =
                    mRes.getDrawable(R.mipmap.sym_keyboard_feedback_language_arrows_right);
